...
const Achievements = () => {
    return (
        <div>
            <div className='font-medium mb-4'>achievements & recognitions.</div>
            <div className='border-l-2 pl-6 hover:border-orange-300 cursor-default transition-all'>
                <div>
                    <ul className='list-disc flex flex-col gap-3 list-inside'>
                        ...
                        <li className='text-sd text-sm'><span className='font-semibold'>Open Source</span>: Hacktoberfest project maintainer 2023 (Foss Events 2.0)</li>
                    </ul>
                </div>
            </div>
        </div>
